...
def helpmessage():
    helpMessage = "✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨" + "\n" + \
                  ...
                  "✨เด้ง @ ➠ เตะแล้วดึงกลับ" + "\n" + \
                  "✨!แทค ➠ แทคชื่อร่องหน" + "\n" + \
                  "✨!มิด ➠ ดูmidคนใส่ร่องหน" "\n" + \
                  "✨!คท ➠ ดู คท คนใส่ร่องหน" + "\n" + \
                  "✨ก็อปปี้ @ ➠ ก็อปปกคนอื่น" + "\n" +\
                  "✨พิมตาม on/off ➠ เปิดเลียนแบบ" + "\n" + \
                  "✨เพิ่มพิมตาม ➠ เพิ่มเลียนแบบ" + "\n" + \
                  "✨ลบพิมตาม ➠ ลบเลียนแบบ" + "\n" + \
...
def helptexttospeech():
    helpTextToSpeech =   "✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨" + "\n" + \
                         ...
                         "👑AutoJoin 「On/Off」 ➠ เข้ากลุ่มออโต้" + "\n" + \
                         "👑AutoRead「On/Off」 ➠ อ่านออโต้" + "\n" + \
                         "👑AutoBlock 「On/Off」 ➠ ออโต้บล็อค" + "\n" + \
                         "👑CheckSticker「On/Off」 ➠ แชร์ลิ้งสติกเกอร์" + "\n" + \
                         "👑ลิ้ง 「On/Off」 ➠ เปิดปิดลิ่งกลุ่ม" + "\n" + \
...
#==============================================================================#
                    ...
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"👍ลบรันเสร็ดแล้วʕ•ᴥ•ʔ")
                    else:
