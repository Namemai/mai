...
def helpmessage():
    helpMessage = "╔═══════════════" + "\n" + \
                  "╠" + "\n" + \
                  "║✍️ᴛ҈ᴇ҈ᴀ҈ᴍ҈🔝Ƭ̶̵̷͓͓͓͓̽̽̽̽H̶̷͓͓͓͓͓̽̽̽̽̽E̶̵̷͓͓͓̽̽̽F̷̶̵̷͓͓͓̽̽̽L̷̶̵̷͓͓͓̽̽̽A̷̶̵̷͓͓͓̽̽̽S̷̶̵̷͓͓͓̽̽̽H̷̶̵̷͓͓͓̽̽̽⚡" + "\n" + \
                  "║" + "\n" + \
                  "╠══✪〘เมนูคำสั่ง〙✪══" + "\n" + \
                  "║" + "\n" + \
                  "╠✪〘คำสั่งต่างๆ〙✪════════" + "\n" + \
...
#==============================================================================#
                    ...
                    try:
                        ...
                        ret_ += "\n╠ คนบล็อค : {}".format(str(len(blockedlist)))
                        ret_ += "\n╠══[ ฝึกแปลไทย ]"
                        ret_ += "\n╠ เวอร์ชั่น : เบต้า 0.01"
                        ret_ += "\n╠ Creator : 🔝ƬΣΛM✍️ŦЂềƒÎάŠħ⚡".format(creator.displayName)
                        ret_ += "\n╚══Ｈ̶̵̷͓͓͓̽̽̽Ｉ ̶̵̷͓͓͓̽̽̽Ｅ̶̵̷͓͓͓̽̽̽Ｔ̶̵̷͓͓͓̽̽̽Ｏ̶̵̷͓͓͓̽̽̽Ｃ̶̵̷͓͓͓̽̽̽Ｉ ̶̵̷͓͓͓̽̽̽Ｈ̶̵̷͓͓͓̽̽̽\n"
...
#==============================================================================#
                    ...
                    nadya.sendMessage(to, "เปิดระบบออโต้บล็อค..👑")
                elif text.lower() == 'autoblock off':
                    settings["autoAdd"] = False
                    nadya.sendMessage(to, "ปิดระบบออโต้บล็อค..👑")
                elif text.lower() == 'autojoin on':
                    settings["autoJoin"] = True
                    nadya.sendMessage(to, "เปิดระบบเข้ากลุ่มออโต้..🔝")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    nadya.sendMessage(to, "ปิดระบบเข้ากลุ่มออโต้..🔝")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    nadya.sendMessage(to, "เปิดระบบออกกลุ่มออโต้..🔰")
                elif text.lower() == 'autojoin off':
                    settings["autoLeave"] = False
                    nadya.sendMessage(to, "ปิดระบบออกกลุ่มออโต้..🔰")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    nadya.sendMessage(to, "เปิดระบบอ่านออโต้..🌟")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    nadya.sendMessage(to, "ปิดระบบอ่านออโต้..🌟")
                    ...
                    nadya.sendMessage(to, "เปิดระบบการกล่าวถึง..⚡")
                elif text.lower() == 'detectmention off':
                    settings["datectMention"] = False
                    nadya.sendMessage(to, "ปิดระบบการกล่าวถึง..⚡")
                elif text.lower() == 'clonecontact':
                    settings["copy"] = True
                    nadya.sendMessage(to, "เปิดระบบการก็อปปี้ด้วยคอนแท็ก..🔥")
#==============================================================================#
                elif text.lower() == 'คท':
