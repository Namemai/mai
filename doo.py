...
#==============================================================================#
                    ...
                    settings["phu1"] = msg.replace("ตั้งเข้า: ","")
                    nadya.sendMessage(msg.to,"➠ ตั้งข้อความต้อนรับสำเร็จ")
                elif "ตั้งออก: " in msg.text:
                    settings["phu2"] = msg.replace("ตั้งออก: ","")
                    nadya.sendMessage(msg.to,"➠ ตั้งข้อความกล่าวถึงคนออกสำเร็จ")
                elif msg.text in ["ตั้งแทค:"]:
                    settings["phu3"] = msg.replace("ตั้งแทค: ","")
                    nadya.sendMessage(msg.to,"➠ ตั้งข้อความกล่าวถึงคนแทคสำเร็จ")
                elif msg.text in ["เชคเข้า","เช็คเข้า"]:
                    nadya.sendMessage(msg.to,"ข้อความต้อนรับล่าสุดคือ\n\n" + str(settings["phu1"]))
                elif msg.text in ["เชคออก","เช็คออก"]:
                    nadya.sendMessage(msg.to,"ข้อความกล่าวถึงคนออกล่าสุดคือ\n\n" + str(settings["phu2"]))
                elif msg.text in ["เชคแทค","เช็คแทค"]:
                    nadya.sendMessage(msg.to,"ข้อความกล่าวถึงคนแทคล่าสุดคือ\n\n" + str(settings["phu3"]))
#==============================================================================#
                elif text.lower() == '!แทค':
                ...
                if op.type == 17:
                  if settings["Wc"] == True:
                     if op.param2 in bot1:
                       ...
                       nadya.sendMessage(op.param1,nadya.getContact(op.param2).displayName + "☞เข้าสู่☞" + str(ginfo.name) + "\n\n" + str(settings["phu1"]) + "\n✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨")
                ...
                if msg.contentType == 0 and sender not in clMID and msg.toType == 2:
                    if "MENTION" in list(msg.contentMetadata.keys()) != None:
                         if settings['detectMention'] == True:
                             ...
                             balas = cName + "\n" + str(settings["phu3"]) + "✍️ͲɆᎪᎷ🔝ʕ•̫͡•ʔஞ௮Ҩஆี✨"]
#==============================================================================#
        if op.type == 55:
