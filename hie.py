...
def helpmessage():
    helpMessage = "╔═══════════════" + "\n" + \
                  "║" + "\n" + \
                  "║✍️ᴛ҈ᴇ҈ᴀ҈ᴍ҈🔝T̶̵̷͓͓͓̽̽̽ ҉H̶̵̷͓͓͓̽̽̽ ҉E̶̵̷͓͓͓̽̽̽ ҉F̶̵̷͓͓͓̽̽̽ ҉L̶̵̷͓͓͓̽̽̽ ҉A̶̵̷͓͓͓̽̽̽ ҉S̶̵̷͓͓͓̽̽̽ ҉H̶̵̷͓͓͓̽̽̽ ҉⚡" + "\n" + \
                  "║" + "\n" + \
                  "╠══✪〘เมนูคำสั่ง〙✪══" + "\n" + \
                  "║" + "\n" + \
                  "╠✪〘คำสั่งต่างๆ〙✪════════" + "\n" + \
...
#==============================================================================#
                    ...
                    start = time.time()
                    nadya.sendMessage(to, "🔝การตอบสนอง...")
                    elapsed_time = time.time() - start
                    nadya.sendMessage(to, "ความเร็วบอท {} วินาที".format(str(elapsed_time)))
