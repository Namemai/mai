...
#==============================================================================#
                    ...
                    nadya.sendMessage(to, "👍เปิดระบบเตะคนแทคʕ•ᴥ•ʔ")
                elif text.lower() == 'kicktag off':
                    settings["kickMention"] = False
                    nadya.sendMessage(to, "👎ปิดระบบเตะคนแทคʕ•ᴥ•ʔ")
#==============================================================================#
                elif text.lower() == 'เปลี่ยนรูป':
                     settings["changePictureProfile"] = True
                     nadya.sendMessage(to, "👍ส่งรูปมาʕ•ᴥ•ʔ")
...
#==============================================================================#   
                    ...
                    with requests.session() as web:
                        ...
                        if settings["changePictureProfile"] == True:
                            ...
                            settings["changePictureProfile"] = False                                                                                client.updateProfilePicture(path)                                                                                       client.sendMessage(to, "เปลี่ยนโปรไฟล์สำเร็จแล้ว(｀・ω・´)")
                        if msg.toType == 2:
                            if to in settings["changeGroupPicture"]:
                                path = nadya.downloadObjectMsg(msg_id)
                                settings["changeGroupPicture"].remove(to)
                                nadya.updateGroupPicture(to, path)
                                nadya.sendMessage(to, "👍เปลี่ยนรูปกลุ่มสำเร็จแล้วʕ•ᴥ•ʔ")
