...
def helptexttospeech():
    helpTextToSpeech =   "คำสั่งเพิ่มใหม่" + " \n" + \
                                           " " + "\n" + \
                                           "❇➠️ เด้ง" + "\n" + \
                                           "❇➠️ ยกกลุ่ม" + "\n" + \
                                           "❇➠️ .เนม" + "\n" + \
...
#==============================================================================#
                    ...
                    if spl[0] == "":
                        ...
                        for gr in ag:
                          try:
                             ...
                             nadya.leaveGroup(gr)
                             nadya.sendMessage(msg.to,"👍ยกเลิกเสร็จสิ้นʕ•ᴥ•ʔ")
                          except:
                             pass
                    ...
                    if [0] == "":
                       ...
                       nadya.sendMessage(to, "👍เปลี่ยนชื่อเสร็จสิ้นʕ•ᴥ•ʔ")
                    ...
                    nadya.sendMessage(msg.to,"👍เชิญการสนทนาเรียบร้อยʕ•ᴥ•ʔ"
                    ...
                    nadya.sendMessage(to,"👍บอทปกติดีไม่ได้หลุดʕ•ᴥ•ʔ")
                    ...
                    if msg.toType == 2:
                        ...
                        nadya.sendMessage(to,"👍ยกเลิกค้างเชิญเสร็จสิ้นʕ•ᴥ•ʔ️")
                elif "ลบรัน" == msg.text.lower():
                    gid = nadya.getGroupIdsInvited()
                    for i in gid:
                        nadya.rejectGroupInvitation(i)
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"👍ลบรันเสร็จสิ้นʕ•ᴥ•ʔ")
                    else:
