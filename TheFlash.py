...
#==============================================================================#
                if text.lower() == 'คำสั่ง':
                    ...
                    nadya.sendMessage(to, "[BY]✍️  ᴛ⃢​ᴇ⃢​ᴀ⃢​ᴍ⃢   🔝ͲᎻᎬᖴ͙͛Ꮮ͙͛ᗩ͙͛ᔑ͙͛Ꮋ͙  ̾⚡")
...
#==============================================================================#
                    ...
                    msg.contentType = 13
                    nadya.sendMessage(to, "✍️  ᴛ⃢​ᴇ⃢​ᴀ⃢​ᴍ⃢   🔝่ͲᎻᎬᖴ͙͛Ꮮ͙͛ᗩ͙͛ᔑ͙͛Ꮋ͙  ̾⚡")
                    nadya.sendContact(to, "u07fb5496b409998a4f1f0af307d2c6e9")
                    ...
                    nadya.sendMessage(to,"โหลดเสร็จสิ้น.."
                    nadya.sendMessage(to,"[BOTBY]\n✍️  ᴛ⃢​ᴇ⃢​ᴀ⃢​ᴍ⃢   🔝ͲᎻᎬᖴ͙͛Ꮮ͙͛ᗩ͙͛ᔑ͙͛Ꮋ͙  ̾⚡"
                    ...
                    if msg.toType == 2:
                        ...
                        nadya.sendMessage(msg.to,"👍〘ยกเลิกค้างเชิญเสร็จสิ้น〙👌")
               elif "ลบรัน" == msg.text.lower():
                    gid = nadya.getGroupIdsInvited()
                    for i in gid:
                        nadya.rejectGroupInvitation(i)
                    if wait["lang"] == "JP":
                        nadya.sendMessage(msg.to,"⚡ลบรันเสร็จสิ้น...")
                    else:
                    ...
                    try:
                        ...
                        ret_ += "\n╠══[  ฝึกแปลไทย ]"
                        ret_ += "\n╠ เวอร์ชั่น : เบต้า 5.00"
                        ret_ += "\n╠ Creator : ✍️  ᴛ⃢​ᴇ⃢​ᴀ⃢​ᴍ⃢   🔝ͲᎻᎬᖴ͙͛Ꮮ͙͛ᗩ͙͛ᔑ͙͛Ꮋ͙  ̾⚡".format(creator.displayName)
