...
#==============================================================================#
                	...
                	settings["Wc"] = True
                    nadya.sendMessage(to, "👍เปิดระบบข้อความตอนรับʕ•ᴥ•ʔ")
                elif text.lower() == 'wc off':
                	settings["Wc"] = False
                    nadya.sendMessage(to, "👎ปิดระบบข้อความตอนรับʕ•ᴥ•ʔ")
                elif text.lower() == 'wq on':
                	settings["Wq"] = True
                    nadya.sendMessage(to, "👍เปิดระบบข้อความตอนรับออกʕ•ᴥ•ʔ")
                elif text.lower() == 'wq off':
                	settings["Wq"] = False
                    nadya.sendMessage(to, "👎ปิดระบบข้อความตอนรับออกʕ•ᴥ•ʔ")
                elif "ตั้งเข้า: " in msg.text:
                    settings["phu1"] = msg.text.replace("ตั้งเข้า: ","")
                    nadya.sendMessage(msg.to,"➠ 👍ตั้งข้อความต้อนรับสำเร็จʕ•ᴥ•ʔ")
                elif "ตั้งออก: " in msg.text:
                    settings["phu2"] = msg.text.replace("ตั้งออก: ","")
                    nadya.sendMessage(msg.to,"➠ 👍ตั้งข้อความกล่าวถึงคนออกสำเร็จʕ•ᴥ•ʔ")
                    ...
                    nadya.sendMessage(msg.to,"👍ข้อความต้อนรับล่าสุดคือʕ•ᴥ•ʔ\n\n" + str(settings["phu1"]))
                elif msg.text in ["เชคออก","เช็คออก"]:
                    nadya.sendMessage(msg.to,"👍ข้อความกล่าวถึงคนออกล่าสุดคือʕ•ᴥ•ʔ\n\n" + str(settings["phu2"]))
                elif msg.text in ["เชคแทค","เช็คแทค"]:
                    nadya.sendMessage(msg.to,"👍ข้อความกล่าวถึงคนแทคล่าสุดคือʕ•ᴥ•ʔ\n\n" + str(settings["phu3"]))	
#============================== ================================================#
                elif text.lower() == '!แทค':
