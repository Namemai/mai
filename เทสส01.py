...
#==============================================================================#
                    ...
                    settings["detectMention"] = True
                    nadya.sendMessage(to,"👍เปิดแทคเสดแล้วʕ•ᴥ•ʔ")                
                elif msg.text in ["ปิดแทค"]:
                    settings["detectMention"] = False
                    nadya.sendMessage(to,"👍ปิดแทคเสดแล้วʕ•ᴥ•ʔ")
                elif msg.text in ["pop1","เชคแทค1"]:
                    nadya.sendMessage(to,"👍ข้อความแทคล่าสุดคือʕ•ᴥ•ʔ\n\n" + str(settings["detectMention"]))
                elif msg.text in ["pop2","เชคแทค2"]:
                    nadya.sendMessage(to,"👍ข้อความแทคล่าสุดคือʕ•ᴥ•ʔ\n\n" + str(settings["detectMention2"]))
                elif "pop1:" in msg.text:
                    settings["detectMention"] = msg.text.replace("pop1: ","")
                    nadya.sendMessage(to,"👍ข้อความแทคล่าสุดคือʕ•ᴥ•ʔ")
                elif "pop2:" in msg.text:
                    settings["detectMention2"] = msg.text.replace("pop2: ","")
                    nadya.sendMessage(to,"👍ข้อความแทคล่าสุดคือʕ•ᴥ•ʔ")
                elif msg.text in ["เปิดเตะแทค"]:
                    settings["kickMention"] = True
                    nadya.sendMessage(to,"👍เปิดแล้วʕ•ᴥ•ʔ")
                elif msg.text in ["ปิดเตะแทค"]:
                    settings["kickMention"] = False
                    nadya.sendMessage(to,"👍ปิดแตะแทคเสดแล้วʕ•ᴥ•ʔ")
#==============================================================================#
            ...
            if msg.toType == 0:
                ...
                if 'MENTION' in msg.contentMetadata.keys() != None:
                     if settings["detectMention"] == True:
                           ...
                           balas = [cName + "\n" + str(settings["detectMention"]) , cName + "\n" + str(settings["detectMention2"])]
                           ret_ = random.choice(balas)
